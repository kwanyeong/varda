...
<body>
	...
	<div class="container">
		<div class="row">
		      <div class="col-md-5">
		         <img src="/resources/images/<%=product.getPdImg()%>" style="width: 100%">
		      </div>
               <div class="col-md-6">
                 <h4><%=product.getPdName() %></h4>
                 <p><b>상품 코드: </b><span class="badge badge-danger"><%=product.getPdItem()%></span>
                 <p><%=product.getPdTag() %>
                 <h4><%=product.getPdPrice() %>원</h4>
                 <p><form name="addForm" action="./addCart.jsp?id=<%=product.getPdItem()%>" method="post">
